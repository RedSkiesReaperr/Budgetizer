...
NUMBER_OF_BUDGETS = Faker::Number.within(range: 0..10)
NUMBER_OF_LINES_PER_BUDGET = Faker::Number.within(range: 30..60)
...
NUMBER_OF_BUDGETS.times do
  ...
  objective = Objective.create!(vital:, non_essential:, saving:)
  budget = Budget.create(objective:, name: "#{Faker::Adjective.positive} budget")

  NUMBER_OF_LINES_PER_BUDGET.times do
    ...
    Line.create(label: Faker::Hobby.activity, amount:, line_type:, budget:, category:)
  end
end
